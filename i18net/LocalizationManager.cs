...
namespace i18net
{
    public static class LocalizationManager
    {
        ...
        private static string _curLang = Configuration.Config.DefaultLang;
        public static void LoadLanguage(string langCode)
        {
            ...
            try
            {
                rfs = File.Open(Configuration.Config.LanguageFilesDir + "/" + langCode + ".json", FileMode.Open);
            ...
            var type = assembly.GetType(Configuration.Config.Namespace + "Localization");
